...
But you control the HTML, so you can simply include a CDN link for most libraries from something like [cdnjs.com](https://cdnjs.com/) or [unpkg.com](https://unpkg.com)
